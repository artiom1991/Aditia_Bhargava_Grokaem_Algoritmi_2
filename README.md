...
> __Массивы:__ память под элементы массива выделяется друг возле друга. Таким образом можно
> рассчитать где находится в памяти 100 элемент и сразу получить его.
> ![array](./images/array.png)

> __Связанные списки:__ память под элементы связанного списка может выделяться в любом месте, но такой список 
> читается последовательно потому-что в 1 элементе записан адрес второго элемента, во втором третьего. 
> Ты не можешь сразу перепрыгнуть пол списка и получить сотый элемент нужно пройти все 100.
